    ...
    return (
            ...
            <div className='text-center m-2 '>
                ...
                {role === 'poster' && <div className={'description-active d-flex flex-column align-items-center justify-content-around'}>
                    ...
                    <div className=''>
                        <div className='font-weight-bold bg-white shadow-sm rounded-pill p-1 '> Wait a Buyer to take the task</div>
                        <div className='d-inline-block text-warning text-center mt-2 ' >Task Assigned</div>
                    </div>
                    <div className=''>
                        <div className='bg-white shadow-sm rounded-pill p-1 font-weight-bold'> Wait the buyer to deliver it before the due time</div>
                        <div className='d-inline-block font-weight-bold text-danger text-center mt-2 '>Task Done</div>
                    </div>
                    <div className=' '>
                        <div className='bg-white shadow-sm rounded-pill p-1  font-weight-bold'> Get things and Pay the buyer</div>
                        <div className='d-inline-block p-1 mt-2  bg-dark text-white text-center border border-muted rounded'>Completed Task</div>
                ...
                {role === 'tasker' && <div className={'description-active d-flex flex-column align-items-center justify-content-around'}>
                    <div className=''>
                        <div className='font-weight-bold bg-white shadow-sm rounded-pill p-1 '> When you want some money in the way home</div>
                    ...
                    <div className=''>
                        <div className='font-weight-bold bg-white shadow-sm rounded-pill p-1 '>Find a task near to your destination</div>
                        <div className='d-inline-block p-1 mt-2 bg-success text-white text-center border border-muted rounded'>Take the task</div>
                    </div>

                    <div className=''>
                        <div className='font-weight-bold bg-white shadow-sm rounded-pill p-1 '>Buy what the poster wants and deliver</div>
                        <div className='d-inline-block p-1 mt-2 bg-danger text-white text-center border border-muted rounded'>Done the Task</div>
                    </div>

                    <div className=''>
                        <div className='font-weight-bold bg-white border border-muted rounded-pill p-1'>Get Money you deserve to</div>
                        <div className='d-inline-block p-1 mt-2 bg-white text-dark text-center border border-muted rounded'>Task Completed</div>
                        <div className="d-inline-block p-1 mt-2 bg-info text-white text-center border border-muted rounded">Leave reviews</div>
                    </div>
