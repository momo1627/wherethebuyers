...
export default function useMyTasks(role:string,filter:string):[IResponse<Data[]>,boolean]{
    ...
    const url = filter === 'all'? `http://ec2-3-89-33-101.compute-1.amazonaws.com/mytasks?${role}=${username}` : `http://ec2-3-89-33-101.compute-1.amazonaws.com/mytasks?${role}=${username}&status=${filter}` 
